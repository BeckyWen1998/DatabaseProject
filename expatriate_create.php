...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
	...
	$Birthday_value = $_POST['Birthday']; 
	$Hireday_value = $_POST['Hireday'];
...
<body>
	...
	<p >
		...
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" style='margin-bottom:50px;' >
			員工姓名: <input type="text" name="Name" />
			...
			出生年月日: <input type="date" id="Birthday" name="Birthday">
			錄用日期: <input type="date" id="Hireday" name="Hireday">
