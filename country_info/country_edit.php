<?php
function updater($Name_value, $Rank_value, $Salary_value, $Phone_value, $Gender_value, $Address_value){
...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
	...
	updater($Name_value, $Rank_value, $Salary_value, $Phone_value, $Gender_value, $Address_value);
}	
...
<body>
	...
	<div align="center">
		...
		請輸入想編輯的姓名(請務必輸入正確)：<input type="text" name="Name" />
